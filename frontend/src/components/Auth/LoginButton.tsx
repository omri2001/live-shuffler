    ...
    <div className="h-screen flex flex-col items-center justify-center bg-spotify-dark px-6">
      <div className="max-w-md w-full text-center">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-5xl font-bold text-spotify-white mb-3">
            Live Shuffler
          </h1>
          <p className="text-spotify-gray text-lg">
            Smart shuffle for your Spotify library
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-spotify-white">
                Weighted genre sliders
              </p>
              <p className="text-xs text-spotify-gray">
                Control your queue mix with 16 music metrics
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-spotify-gray">
                Skip, reorder, and manage playback live
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-spotify-gray">
                Liked songs, playlists, or albums
              </p>
            </div>
          </div>
        </div>
        ...
        <p className="text-spotify-gray/50 text-xs mt-6">
